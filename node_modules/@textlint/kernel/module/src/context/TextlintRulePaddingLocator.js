export const isTextlintRuleErrorPaddingLocObject = (loc) => {
...
export const isTextlintRuleErrorPaddingLocRange = (range) => {
    return Array.isArray(range) && range.length === 2;
};
export const isTextlintRuleErrorPaddingLocation = (o) => {
...
export const createPaddingLocator = () => {
    return {
        at(index) {
