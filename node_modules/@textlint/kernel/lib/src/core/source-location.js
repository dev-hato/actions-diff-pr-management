...
`);
    ...
    if (padding.padding !== undefined) {
        assert_1.default.ok((0, TextlintRulePaddingLocator_1.isTextlintRuleErrorPaddingLocation)(padding.padding), "reported { padding } is invalid format.");
    }
};
/**
...
const resolveFixCommandLocation = ({ node, ruleError }) => {
    ...
    assert_1.default.ok(typeof ruleError.fix === "object", "fix should be FixCommand object");
