...
export declare function createPr({ sourceBranch, targetBranch, prTitle: title, prBody: rawBody, labels, draftPR, platformOptions, }: CreatePRConfig): Promise<Pr | null>;
...
export declare function commitFiles(config: CommitFilesConfig): Promise<CommitSha | null>;
