...
export declare type Qualifier = 0 | 1 | 2;
export declare type Shortcode = string;
export declare type ShortcodePreset = 'cldr-native' | 'cldr' | 'discord' | 'emojibase-legacy' | 'emojibase-native' | 'emojibase' | 'github' | 'iamcal' | 'joypixels' | 'slack';
export declare type LocalizedShortcodePreset = `${Locale}/${ShortcodePreset}`;
...
export declare type VersionDataset = Record<string, string[]>;
export declare type ShortcodesDataset = Record<Hexcode, string[] | string>;
export declare type HexcodesDataset = Record<Hexcode, Record<Hexcode, Qualifier>>;
...
export declare type CDNUrlFn = (path: string, version: string) => string;
