...
const processor_map_1 = require("./processor-map");
const config_1 = require("../config/config");
const find_util_1 = require("../util/find-util");
const textlint_module_loader_1 = require("./textlint-module-loader");
const execute_file_backer_manager_1 = require("./execute-file-backer-manager");
const cache_backer_1 = require("./execute-file-backers/cache-backer");
...
new TextLintEngine({
 rulesBaseDirectory: directory
    ...
    executeOnFiles(files) {
        ...
        const targetFiles = (0, find_util_1.findFiles)(patterns, { ignoreFilePath: this.config.ignoreFile });
