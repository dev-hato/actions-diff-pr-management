...
var get_number_of_pull_requests_exports = {};
__export(get_number_of_pull_requests_exports, {
  script: () => script
});
module.exports = __toCommonJS(get_number_of_pull_requests_exports);

// node_modules/source-map-support/register.js
require_source_map_support().install();

// src/get_pull_requests.ts
